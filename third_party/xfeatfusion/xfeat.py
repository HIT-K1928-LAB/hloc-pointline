...
class XFeat(nn.Module):
	...
	"""
#142000
	def __init__(self, weights = '/home/hxy/doctor/feature dectect/hloc/Hierarchical-Localization/third_party/xfeatfusion/weights/best.pth', top_k = 4096, detection_threshold=0.05):
		super().__init__()
