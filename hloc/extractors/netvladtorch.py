...
encoder_dim = 512
encoder = models.vgg16(weights=VGG16_Weights.IMAGENET1K_V1)
...
# checkpoint = torch.load("", map_location="")
...
class gaussvladplusvgghloc(BaseModel):
    ...
    # default_conf = {"model_name": "VGG16-NetVLAD-Pitts30K", "whiten": True}
        weight = "/home/hxy/doctor/feature dectect/hloc/Hierarchical-Localization/hloc/extractors/weights/netvlad-vgg.tar"
    ...
    def _forward(self, data):
        image = data["image"]
        desc = self.model.pool(self.model.encoder(image))
